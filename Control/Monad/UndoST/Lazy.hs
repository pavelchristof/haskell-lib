...
{- |
Module      :  Control.Monad.UndoST.Lazy
Description :  A revertible, lazy state-transformer monad.
...
The lazy variant of the UndoST monad.
...
module Control.Monad.UndoST.Lazy where
